...
namespace EWYRYV_HFT_202223.Endpoint
{
    public class Startup
    {
        ...
        {
            services.AddTransient<TeamDbContext>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "EWYRYV_HFT_202223.Endpoint", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "EWYRYV_HFT_202223.Endpoint v1"));
            }
